...
@Component({
  selector: 'app-view-a-product',
  templateUrl: './view-a-product.component.html',
  styleUrls: ['./view-a-product.component.css']
})
export class ViewAProductComponent implements OnInit {

    @ViewChild('toastElement')
  toastElement!: ElementRef;

  @ViewChild('PromoModel') thePromoModel:any;
  ...
  mEdit()
  {
    ...
    if(this.button.innerText === "edit"){
        this.boolEdit = false;
        this.clsEditable = "editable"; 
        this.button.innerText = "Save";
        this.z_index = "clsZindex"
    }
    else if(this.button.innerText === "Save"){
      this.boolEdit = true;
  ...
  onPromo(){
    ...
    if(this.products.promo.onPromo)
    {
      this.products.promo = {
        onPromo: false,
        promoDesc: '',
      ...
      this.mUpdateProduct()
      this.thePromoModel.nativeElement.click();
    }
    else
    {
      if(this.products.promo.newPrice < this.products.price){
        this.products.promo.onPromo = true
        this.mUpdateProduct();
        this.thePromoModel.nativeElement.click();
      }
    }
