...
export class UserViewProductComponent {
  ...
  constructor(private route:ActivatedRoute, private fakeApi:FakeStoreService, private products: CustProductsService, private cart:AddToCartService){}
  ...
  mAddToCart(){
    this.cart.AddToCart().subscribe((data) => {
